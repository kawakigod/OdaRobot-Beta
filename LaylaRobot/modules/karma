...
from LaylaRobot.utlis.dbfunc import (update_karma, get_karma, get_karmas,
                                   int_to_alpha, alpha_to_int)
from LaylaRobot.utlis.filter_groups import karma_positive_group, karma_negative_group
from pyrogram import filters


regex_upvote = r"^((?i)\+|\+\+|\+1|thank you|thanks|👍|pro|thx|tq|ty)$"
